...
class MowerMovementState {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MowerMovementState(null);
  ...
  static datatype() {
    ...
    return 'am_msgs/MowerMovementState';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MowerMovementState(null);
...
module.exports = MowerMovementState;
