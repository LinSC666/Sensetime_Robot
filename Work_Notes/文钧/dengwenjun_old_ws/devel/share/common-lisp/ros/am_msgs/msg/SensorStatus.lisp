...
(cl:defmethod cl:initialize-instance :after ((m <SensorStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SensorStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name am_msgs-msg:<SensorStatus> is deprecated: use am_msgs-msg:SensorStatus instead.")))
...
(cl:defmethod sensorStatus-val ((m <SensorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:sensorStatus-val is deprecated.  Use am_msgs-msg:sensorStatus instead.")
  (sensorStatus m))

(cl:ensure-generic-function 'operationalMode-val :lambda-list '(m))
(cl:defmethod operationalMode-val ((m <SensorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:operationalMode-val is deprecated.  Use am_msgs-msg:operationalMode instead.")
  (operationalMode m))

(cl:ensure-generic-function 'mowerInternalState-val :lambda-list '(m))
(cl:defmethod mowerInternalState-val ((m <SensorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:mowerInternalState-val is deprecated.  Use am_msgs-msg:mowerInternalState instead.")
...
(cl:defmethod controlState-val ((m <SensorStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:controlState-val is deprecated.  Use am_msgs-msg:controlState instead.")
  (controlState m))
