...
(cl:defmethod cl:initialize-instance :after ((m <BatteryStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name am_msgs-msg:<BatteryStatus> is deprecated: use am_msgs-msg:BatteryStatus instead.")))
...
(cl:defmethod batteryAVoltage-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:batteryAVoltage-val is deprecated.  Use am_msgs-msg:batteryAVoltage instead.")
  (batteryAVoltage m))

(cl:ensure-generic-function 'batteryACurrent-val :lambda-list '(m))
(cl:defmethod batteryACurrent-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:batteryACurrent-val is deprecated.  Use am_msgs-msg:batteryACurrent instead.")
  (batteryACurrent m))

(cl:ensure-generic-function 'batteryBVoltage-val :lambda-list '(m))
(cl:defmethod batteryBVoltage-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:batteryBVoltage-val is deprecated.  Use am_msgs-msg:batteryBVoltage instead.")
  (batteryBVoltage m))

(cl:ensure-generic-function 'batteryBCurrent-val :lambda-list '(m))
(cl:defmethod batteryBCurrent-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:batteryBCurrent-val is deprecated.  Use am_msgs-msg:batteryBCurrent instead.")
  (batteryBCurrent m))
