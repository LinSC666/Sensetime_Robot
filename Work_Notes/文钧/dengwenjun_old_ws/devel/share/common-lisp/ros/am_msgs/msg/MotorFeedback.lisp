...
(cl:defmethod cl:initialize-instance :after ((m <MotorFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name am_msgs-msg:<MotorFeedback> is deprecated: use am_msgs-msg:MotorFeedback instead.")))
...
(cl:defmethod omega-val ((m <MotorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:omega-val is deprecated.  Use am_msgs-msg:omega instead.")
  (omega m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <MotorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:current-val is deprecated.  Use am_msgs-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'ticks-val :lambda-list '(m))
(cl:defmethod ticks-val ((m <MotorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:ticks-val is deprecated.  Use am_msgs-msg:ticks instead.")
  (ticks m))

(cl:ensure-generic-function 'controlOmega-val :lambda-list '(m))
(cl:defmethod controlOmega-val ((m <MotorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:controlOmega-val is deprecated.  Use am_msgs-msg:controlOmega instead.")
  (controlOmega m))

(cl:ensure-generic-function 'controlPower-val :lambda-list '(m))
(cl:defmethod controlPower-val ((m <MotorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:controlPower-val is deprecated.  Use am_msgs-msg:controlPower instead.")
  (controlPower m))

(cl:ensure-generic-function 'hold_position-val :lambda-list '(m))
(cl:defmethod hold_position-val ((m <MotorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader am_msgs-msg:hold_position-val is deprecated.  Use am_msgs-msg:hold_position instead.")
  (hold_position m))
