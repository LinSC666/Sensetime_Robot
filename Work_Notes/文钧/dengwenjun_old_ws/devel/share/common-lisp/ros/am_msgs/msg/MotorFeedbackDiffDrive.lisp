...
(cl:defclass <MotorFeedbackDiffDrive> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (left
    :reader left
    :initarg :left
    :type am_msgs-msg:MotorFeedback
    :initform (cl:make-instance 'am_msgs-msg:MotorFeedback))
   (right
    :reader right
    :initarg :right
    :type am_msgs-msg:MotorFeedback
...
(cl:defmethod cl:initialize-instance :after ((m <MotorFeedbackDiffDrive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorFeedbackDiffDrive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name am_msgs-msg:<MotorFeedbackDiffDrive> is deprecated: use am_msgs-msg:MotorFeedbackDiffDrive instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorFeedbackDiffDrive>)))
  ...
  "am_msgs/MotorFeedbackDiffDrive")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorFeedbackDiffDrive)))
  "Returns string type for a message object of type 'MotorFeedbackDiffDrive"
  "am_msgs/MotorFeedbackDiffDrive")
