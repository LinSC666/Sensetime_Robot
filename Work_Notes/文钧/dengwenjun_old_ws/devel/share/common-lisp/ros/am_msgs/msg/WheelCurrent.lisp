...
(cl:defmethod cl:initialize-instance :after ((m <WheelCurrent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelCurrent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name am_msgs-msg:<WheelCurrent> is deprecated: use am_msgs-msg:WheelCurrent instead.")))
