...
#include <am_msgs/BatteryStatus.h>
#include <am_msgs/CurrentStatus.h>
#include <am_msgs/Loop.h>
#include <am_msgs/MotorFeedback.h>
#include <am_msgs/MotorFeedbackDiffDrive.h>
#include <am_msgs/SensorStatus.h>
#include <am_msgs/WheelCurrent.h>
#include <am_msgs/WheelEncoder.h>
#include <am_msgs/WheelPower.h>
...
protected:
    ...
    void powerCallback(const am_msgs::WheelPower::ConstPtr& power);
    void modeCallback(const std_msgs::UInt16::ConstPtr& msg);
    void joyCallback(const sensor_msgs::Joy::ConstPtr& j);

    void simLoopCallback(const am_msgs::Loop& msg);
    ...
    // Automower status
    am_msgs::Loop loop;
    am_msgs::SensorStatus sensorStatus;
    unsigned short requestedState;
    am_msgs::CurrentStatus currentStatus;
    
    am_msgs::WheelEncoder encoder;
    am_msgs::WheelCurrent wheelCurrent;
    am_msgs::WheelPower wheelPower;
    am_msgs::MotorFeedbackDiffDrive motorFeedbackDiffDrive;
    ...
    bool printCharge;
    am_msgs::BatteryStatus batteryStatus;
...
typedef std::shared_ptr<AutomowerSafe> AutomowerSafePtr;
